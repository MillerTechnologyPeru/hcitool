...
final class CommandTests: XCTestCase {
    ...
    func testTestEnd() {
        ...
        testController.queue = [
            .command(LowEnergyCommand.testEnd.opcode,[0x1f, 0x20, 0x00]),
    ...
    func testTransmitterTest() {
        ...
        testController.queue = [
            .command(LowEnergyCommand.transmitterTest.opcode,[0x1e, 0x20, 0x02, 0x01, 0x02]),
    ...
    func testEncrypt() {
        ...
        testController.queue = [
            .command(LowEnergyCommand.encrypt.opcode, [0x17, 0x20, 0x20, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22,
