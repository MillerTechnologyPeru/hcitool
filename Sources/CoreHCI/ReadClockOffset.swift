...
public struct ReadClockOffsetCommand: ArgumentableCommand {
    ...
    public static let commandType: CommandType = .readClockOffset
    ...
    public func execute <Controller: BluetoothHostControllerInterface> (controller: Controller) throws {
        ...
        let offset = try controller.readClockOffset(handle: connectionComplete.handle)
        
        print("Clock offset = \(offset.rawValue.toHexadecimal())")
    }
}

public extension ReadClockOffsetCommand {
